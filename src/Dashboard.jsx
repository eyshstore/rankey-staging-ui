...
const Dashboard = ({ setIsLoggedIn }) => {
  ...
  return (
    <div className="flex flex-col h-screen overflow-hidden">
      <div className="flex items-center justify-between p-3 border-b border-white shrink-0">
      ...
      <div className="flex flex-1 min-h-0">
        <div className="w-1/6 border-r border-white shrink-0">
          <button
        ...
        <div className="w-1/2 border-r border-white flex flex-col">
        ...
        <div className="w-1/2 flex flex-col min-h-0">{details}</div>
      </div>
