    ...
    scansDisplay = scans.map((entry) => {
      ...
      switch (entry.state) {
        ...
        case "paused":
          stateControls = (
            <button
              onClick={(e) => handleResume(entry._id, e)}
              className="bg-green-600 hover:bg-green-800 text-white p-2 rounded flex items-center justify-center w-10 h-10"
              title="Resume Scan"
            >
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
        ...
        case "halting":
          stateControls = (
            <span className="text-gray-400 p-2 flex items-center justify-center w-10 h-10" title="Scan is stopping">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6 animate-spin">
                <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0 3.181 3.183a8.25 8.25 0 0 0 13.803-3.7M4.031 9.865a8.25 8.25 0 0 0 13.803-3.7l3.181 3.182m0-4.991v4.99" />
              </svg>
            </span>
          );
          break;
